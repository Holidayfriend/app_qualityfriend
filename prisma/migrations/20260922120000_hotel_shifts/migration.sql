...
CREATE UNIQUE INDEX IF NOT EXISTS "hotel_shifts_hotel_tenant_id_user_id_work_date_key" ON "hotel_shifts"("hotel_tenant_id", "user_id", "work_date");
CREATE INDEX IF NOT EXISTS "hotel_shifts_hotel_tenant_id_work_date_idx" ON "hotel_shifts"("hotel_tenant_id", "work_date");
CREATE INDEX IF NOT EXISTS "hotel_shifts_user_id_work_date_idx" ON "hotel_shifts"("user_id", "work_date");
CREATE INDEX IF NOT EXISTS "hotel_shifts_created_by_id_idx" ON "hotel_shifts"("created_by_id");
CREATE INDEX IF NOT EXISTS "hotel_shifts_template_id_idx" ON "hotel_shifts"("template_id");
