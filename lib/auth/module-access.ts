...
const defaults:Record<"EMPLOYEE"|"TEAM_LEAD"|"MANAGEMENT",Set<string>>={
 EMPLOYEE:new Set(["dashboard","aiAssistant","chat","handovers","tasks","housekeeper","repairs","notes","manuals","activityLog","recycleBin","settings"]),
 ...
 MANAGEMENT:new Set(["dashboard","aiAssistant","chat","handovers","tasks","housekeeping","repairs","notes","schedule","manuals","revenue","activityLog","recycleBin","settings"]),
};
const forecastModules=["budget","revenue","competitors"] as const;
