...
export const jobsSeed: Job[] = [
  { id: "service1", title: "Servicemitarbeiter (w/m/d) Vollzeit/Teilzeit 🍽", dept: "restaurant", type: "fullOrPart", start: "immediately", notes: "family team, lakeside, staff meals, regular hours", description: "<p>We are looking for service staff for our restaurant team – full-time or part-time.</p><p>You take care of guests from greeting to goodbye, work closely with kitchen and reception, and keep service calm even when the terrace is full.</p>", autoMessage: "", location: "Obereggen", cvRequired: false, status: "active", langs: ["de", "en", "it"], clicks: 397, apps: 7, conv: "1.76%" },
  { id: "koch1", title: "Kochlehrling (m/w/d) oder Chef de Partie", dept: "kitchen", type: "fullOrPart", start: "immediately", notes: "family team, lakeside, staff meals, training, regular hours", description: "<p>We are looking for a Kochlehrling or Chef de Partie for our hotel kitchen.</p><p>You cook with fresh local produce, support the brigade during breakfast and dinner, and keep your station clean and organised. Apprentices are welcome – we train on the job.</p>", autoMessage: "", location: "Obereggen", cvRequired: false, status: "active", langs: ["de", "it"], clicks: 320, apps: 11, conv: "3.44%" },
  { id: "zimmer1", title: "Zimmermädchen in Teilzeit oder Vollzeit 🧹", dept: "housekeeping", type: "part", start: "immediately", notes: "family team, staff meals, regular hours", description: "<p>We are looking for housekeeping staff for our rooms and spa area.</p><p>You keep rooms clean and welcoming, work independently, and help the team when occupancy is high.</p>", autoMessage: "", location: "Obereggen", cvRequired: false, status: "active", langs: ["de"], clicks: 21, apps: 1, conv: "4.76%" },
  { id: "reception1", title: "Front Desk Receptionist at Weihrerhof Hotel", dept: "reception", type: "full", start: "immediately", notes: "", description: "", autoMessage: "", location: "", cvRequired: false, status: "draft", langs: ["en"], clicks: 0, apps: 0, conv: "–" },
  { id: "kellner1", title: "Wir suchen Kellner(innen) in Vollzeit/Teilzeit", dept: "restaurant", type: "fullOrPart", start: "immediately", notes: "", description: "", autoMessage: "", location: "", cvRequired: false, status: "archived", langs: ["de"], clicks: 184, apps: 9, conv: "4.89%" },
  { id: "reception2", title: "Wir suchen einen Rezeptionsmitarbeiter (m/w/d) ☀️", dept: "reception", type: "full", start: "immediately", notes: "", description: "", autoMessage: "", location: "", cvRequired: false, status: "archived", langs: ["de", "it"], clicks: 37, apps: 1, conv: "2.70%" },
];
