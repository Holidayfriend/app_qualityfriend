...
function descriptions(actor: string, entry: AuditEntry) {
  ...
  const entityNames = {
    ...
    it: { DEPARTMENT: "reparto", TEAM: "team", HOTEL: "hotel", USER: "utente", EXTRA_JOB: "lavoro aggiuntivo", FLOOR: "piano", ROOM_CATEGORY: "categoria camera", ROOM: "camera", RECRUITING_JOB: "annuncio di lavoro", RECRUITING_APPLICATION: "candidatura", RECRUITING_SETTINGS: "impostazioni selezione", RECRUITING_EMAIL_TEMPLATE: "modello e-mail", RECRUITING_EMPLOYEE: "dipendente", NOTE: "nota", NOTE_TEMPLATE: "modello di nota", MANUAL: "manuale", REPAIR: "riparazione", REPAIR_TEMPLATE: "modello di riparazione", HANDOVER: "consegna", HANDOVER_TEMPLATE: "modello di consegna", TASK: "compito", CHECKLIST: "checklist", CHECKLIST_TEMPLATE: "modello di checklist" },
  } as const;
