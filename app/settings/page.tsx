...
export default function SettingsPage() {
  ...
  const sections = [
    { title: `👤 ${s.usersTeams}`, items: [["👤", s.manageUsers, s.manageUsersDescription, ""], ["🏢", s.manageDepartments, s.manageDepartmentsDescription, "/settings/departments"], ["👥", s.manageTeams, s.manageTeamsDescription, "/settings/departments"], ["🔑", s.roles, s.rolesDescription, ""]] },
    { title: `🧠 ${s.aiKnowledge}`, items: [["📚", s.knowledge, s.knowledgeDescription, ""], ["🤖", s.training, s.trainingDescription, ""]] },
    { title: `⚙️ ${s.general}`, wide: true, items: [["🌐", s.defaultLanguage, s.defaultLanguageDescription, ""], ["🗑️", s.recycleBin, s.recycleBinDescription, ""], ["📋", s.activityLog, s.activityLogDescription, ""]] },
  ];
