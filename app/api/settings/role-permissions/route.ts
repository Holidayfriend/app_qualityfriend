...
const roles = new Set(["EMPLOYEE", "TEAM_LEAD", "MANAGEMENT"]), modules = new Set(["dashboard", "aiAssistant", "chat", "mcp", "handovers", "tasks", "housekeeping", "housekeeper", "repairs", "notes", "schedule", "recruiting", "manuals", "budget", "revenue", "competitors", "users", "departmentTeams", "roles"]); type Role = "EMPLOYEE" | "TEAM_LEAD" | "MANAGEMENT";
